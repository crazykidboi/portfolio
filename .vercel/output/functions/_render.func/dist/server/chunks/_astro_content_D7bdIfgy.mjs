import { A as AstroError, R as RenderUndefinedEntryError, a as createComponent, u as unescapeHTML, d as renderTemplate, U as UnknownContentCollectionError, j as escape, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, e as renderComponent } from './astro/server_CHJvz4ud.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_B_Pab31o.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BkKkjLbw.mjs').then(n => n._);
